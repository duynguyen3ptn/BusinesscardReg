...
def getPredictions(image):
    ...
    dataframe_info['label'] = dataframe_info['label'].str.replace('\r', '')
    # print("dataframe_info['label'] ", dataframe_info['label'] )
    # Bounding Box
    ...
    img_tagging['label'] = [label[0].lstrip('[').rstrip('\r') for label in img_tagging['label']]
    img_bb = image.copy()
